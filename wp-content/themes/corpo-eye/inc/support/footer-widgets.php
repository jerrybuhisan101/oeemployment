 ...
 * @since 1.0.0
 */
class Corpo_Eye_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'corpo_eye';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'corpo-eye' ), $i ),
...
// Initialize.
$corpo_eye_footer_widgets = new Corpo_Eye_Footer_Widgets();
